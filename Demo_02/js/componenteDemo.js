 ...
 */
    ...
    obtenerCoordenadaX: function(elemento, parent) {
        ...
        //Obtenemos es estilo del elemento
        ...
        //let diferenciaAtura = padding top - (paddingBottom + marginBottom)

        //let top = elemento.offsetTop;
        let top = elemento.offsetTop - elemento.parentNode.offsetTop;
        ...
        console.log("Calcular X -> " + offTopParent + " + " + parent_height + " - " + (top / 10) + " - "  + paddingTop + " - " + ((height / 10) / 2));

        return offTopParent + parent_height - (top / 10) - (paddingTop / 10) - ((height / 10) / 2);
    },
    ...
    obtenerCoordenadaZ: function(elemento, elementoPadre) {
        ...
        //OffsetLeft Elemento si no es el Body
        let offsetLeft = 0;
        if(elemento.childElementCount > 0) {
            offsetLeft = elemento.offsetLeft / 100;
        } else {
            offsetLeft = elemento.parentElement.clientLeft;
        }

        //let offsetLeft = elemento.parentElement.clientLeft;
        ...
        console.log("Calcular Z -> AnchoMitad: " + ancho + " +  OffsetLeft: " + offsetLeft + " + PaddingLeft: " + paddingLeft/100 + " - MitadanchoPadre: " + anchoPadre + " - paddingRight: " + paddingRight/100);
        return (ancho + offsetLeft + paddingLeft/100) - anchoPadre - paddingRight/100;
    },
    ///////////////////////////////////////////////////////////////////////////////
    ...
    obtenerPosContenedor: function(elemento, nivel) {
        ...
        let paddingBottom = parseInt(style.paddingBottom);
        //let altura_margin = parseInt(margin);
        console.log("MarginTop: " + marginTop + " -- paddingTop: " + paddingTop + " -- marginBottom: " + marginBottom + " -- paddingBottom: " + paddingBottom);
        ...
        let posicionX = this.obtenerCoordenadaX(elemento, elemento.parentNode) + paddingTop/10 - ((paddingBottom + marginBottom)/10);
        let posicionY = ladoY;
        let posicionz = this.obtenerCoordenadaZ(elemento, elemento.parentNode);
        let pos = new THREE.Vector3(posicionX,posicionY,posicionz);

        console.log(" Box contenedor de: " + elemento.nodeName);
        console.log(" Dimensiones: ladoX-> " + ladoX + "  ladoY-> " + ladoY + "  ladoZ->  " + ladoZ);
        console.log(" Coordenadas: X-> " + posicionX + "  Y-> " + posicionY + "  Z->  " + posicionz);
